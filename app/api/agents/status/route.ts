...
const ALL_AGENTS = [
  ...
  { name: 'thunder', corp: 'xforce', role: 'Threads' },
  { name: 'surge', corp: 'xforce', role: 'Growth' },
  { name: 'flint', corp: 'xforce', role: 'Hot Takes' },
  { name: 'nova_x', corp: 'xforce', role: 'Spaces' },
  { name: 'forge', corp: 'xforce', role: 'Calendar' },
  { name: 'trace', corp: 'xforce', role: 'Virality' },
  // LinkedElite
  ...
  { name: 'voice', corp: 'linkedelite', role: 'Comments' },
  { name: 'prism', corp: 'linkedelite', role: 'Personal Brand' },
  { name: 'mentor', corp: 'linkedelite', role: 'Thought Leadership' },
  { name: 'amplify', corp: 'linkedelite', role: 'Engagement' },
  // GramGod
  ...
  { name: 'reel', corp: 'gramgod', role: 'Reels' },
  { name: 'story', corp: 'gramgod', role: 'Stories' },
  { name: 'caption', corp: 'gramgod', role: 'Captions' },
  { name: 'hashtag', corp: 'gramgod', role: 'Hashtags' },
  { name: 'tribe', corp: 'gramgod', role: 'Community' },
  { name: 'fanbase', corp: 'gramgod', role: 'Super Fans' },
  { name: 'rescue', corp: 'gramgod', role: 'Crisis' },
  // PagePower
  ...
  { name: 'onboard', corp: 'hrforce', role: 'Onboarding' },
  { name: 'culture', corp: 'hrforce', role: 'Culture' },
  { name: 'train', corp: 'hrforce', role: 'Training' },
  { name: 'eval', corp: 'hrforce', role: 'Evaluation' },
  { name: 'social', corp: 'hrforce', role: 'Events' },
  { name: 'advocate', corp: 'hrforce', role: 'Advocacy' },
  // LegalShield Corp
  { name: 'judge', corp: 'legalshield', role: 'CEO' },
  { name: 'policy', corp: 'legalshield', role: 'Policy' },
  { name: 'risk', corp: 'legalshield', role: 'Risk' },
  { name: 'shadow', corp: 'legalshield', role: 'Shadowban' },
  { name: 'copyright', corp: 'legalshield', role: 'Copyright' },
  { name: 'gdpr', corp: 'legalshield', role: 'Privacy' },
  { name: 'defame', corp: 'legalshield', role: 'Defamation' },
  { name: 'appeal', corp: 'legalshield', role: 'Appeals' },
  { name: 'counsel', corp: 'legalshield', role: 'Counsel' },
  // FinanceDesk Corp
  ...
  { name: 'invoice', corp: 'financedesk', role: 'Invoices' },
  { name: 'sponsor', corp: 'financedesk', role: 'Sponsorships' },
  { name: 'revenue', corp: 'financedesk', role: 'Revenue' },
  { name: 'collab', corp: 'financedesk', role: 'Collabs' },
  { name: 'grants', corp: 'financedesk', role: 'Grants' },
  { name: 'forecast', corp: 'financedesk', role: 'Forecasting' },
]
